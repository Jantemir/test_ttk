            ...
            <nav class="bg-white border-b border-gray-100">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ms-6 break-keep" v-else>
                            <ResponsiveNavLink :href="route('login')" as="button" class="min-w-20 border-s-0">
                                Log In
                            </ResponsiveNavLink>
                        </div>
                ...
                >
                    <div class="pt-2 pb-3 space-y-1">
                        <ResponsiveNavLink :href="route('sections.index')" :active="route().current('sections.index')">
                            Sections
                        </ResponsiveNavLink>
